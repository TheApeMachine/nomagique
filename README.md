...
| `physics/fluid` | Periodic PIC, CPU gas reference, and coupled Metal gas/omega-wave domain with CFL-scaled RK2 increments and one shared gas/gather density resolution            |
